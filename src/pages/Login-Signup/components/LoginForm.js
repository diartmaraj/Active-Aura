...
const LoginForm = () => {
  ...
  return (
    ...
    <form onSubmit="" className="flex flex-col justify-center items-center w-full p-6 border-gray-200  z-10 ">
            <h1 className='text-2xl font-semibold mb-6 text-white lg:text-black'>Log in</h1>
            ...
            <InputText
             ...
             <div className='flex justify-between items-center w-full px-2 mb-2 lg:mb-8'>
              <div className="flex justify-center items-center ">
                ...
                <label htmlFor="RememberMe" className="ml-2 text-white lg:text-black text-sm">Remember me</label>
              </div>
              <p className='text-white lg:text-black text-sm'>Forgot password?</p>
             </div>
             <Button2 label="Log in" color="bg-primary" type="submit" extraStyle="w-full" />
              <Link to="/signUp">
