  ...
  return (
    <section className="relative flex flex-col justify-center items-center background-gradient2 pb-64 tablet:pb-32 overflow-hidden">
      ...
      <div className="flex items-center space-x-4">
        ...
        <Button1 label="Subscribe" extraStyle="h-12" />
      </div>
    <div className="">
      <img
        src={MasterMindGold}
        alt="Master Mind Gold"
        className="h-72 max-sm:h-52 object-contain transform rotate-25 absolute max-[370px]:top-40 max-[325px]:top-56 -left-16 top-32 tablet:top-0 max-w-none"
      />

      <img
        src={MasterMindRed}
        alt="Master Mind Red"
        className="h-72 max-sm:h-52 object-contain transform -rotate-25 absolute max-[370px]:top-40 max-[325px]:top-56 -right-16 top-32 tablet:top-0 max-w-none"
      />
      </div>
    </section>
  );
