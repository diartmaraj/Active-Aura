...
const MostPopular = ({ isFiltersOpen, toggleFilters ,filteredProducts}) => {
  ...
  return (
    <section className='flex flex-col justify-center items-center w-full pb-10 padding-x'>
        ...
        <div className={`flex justify-between items-center w-full gap-4 overflow-x-auto`}>
            ...
            <p className='text-base font-semibold text-center text-nowrap max-sm:text-sm'>Most popular products</p> 
